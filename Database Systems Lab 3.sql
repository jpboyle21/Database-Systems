...
--lists order number and the totalUSD of all orders--
select totalUSD, ordNumber
from orders;

--name and cities where name is Smith--
select name, city
from agents
where name = 'Smith';

--gave product number, name and price on products where the quantity was greater than 200100--
select pid, name, priceUSD
from Products
where quantity > 200100;

--name and city of customers located in Duluth--
select name, city
from Customers
where city = 'Duluth';

--name of agents who are not located in Duluth or NY--
select distinct name
from agents
where city != 'Duluth'
and city != 'New York';

--all details where products not located in Dallas or Duluth amd price is greater than or equal to 1--
select *
from Products
where city != 'Dallas'
and city != 'Duluth'
...
--all details of orders placed in Feb or May--
select  *
from Orders
where month = 'Feb'
or month = 'May';

--all details of orders in february that are greater than 600--
select *
from orders
where month = 'Feb' 
and totalUSD >= 600;

--all orders from customer c005, who does not exist--
select *
from orders
where cid = 'c005';

--Submitted By John Boyle...Database Systems...2/7/2017...LAB 3--